...
export const workExperience = [
  {
    ...
    location: "London, UK",
    desc: "Developed data-driven policy tools using Python and LLM-based workflows, automating insights and streamlining decision-making processes.",
  ...
  //   desc: "Developed and maintained Python-based backend services, streamlining data pipelines and improving system performance to enhance platform reliability and user experience.",    
  ...
  // },
  {
    ...
    location: "Pune, India",
    desc: "Built forecasting models, ETL pipelines, and dashboards for production and inventory data, while contributing to ERP development and automating reporting workflows.",

...
export const gridItems = [
  {
    ...
    //title: "I design and engineer data-driven solutions that bridge advanced AI research with real-world implementation. With 5+ years of experience in data analytics, RAG architectures, LLMs, and cloud infrastructure, I build scalable pipelines and AI-powered applications that address challenges across manufacturing, governance, and policy. My expertise spans predictive modelling, ETL engineering, fine-tuning open-source models, and deploying end-to-end solutions that make data and machine intelligence more accessible, reliable, and impactful.",
    title: "I build AI systems that make it to production. With 5+ years across LLM engineering, agentic architecture, and cloud infrastructure, I currently design enterprise GenAI agent frameworks on Microsoft Foundry, MCP tool servers, human-in-the-loop approval layers, and the orchestration that makes autonomous agents safe to deploy. Previously I contributed to AI governance frameworks adopted across 56 Commonwealth member states. My work spans agentic systems, RAG pipelines, fine-tuning, ETL engineering, and full-stack deployment on Azure and AWS.",
    description: "",
...
export const workExperience = [
  { 
     ...
     desc: "Designing and deploying GenAI agents and MCP servers with Microsoft Foundry for enterprise clients, building end-to-end agentic AI workflows from data ingestion to production.",
   ...
   },
   {
    ...
    location: "London, UK",
    desc: "Built LLM-powered policy intelligence tools using Python and RAG workflows, and contributed to AI governance frameworks defining responsible AI deployment across 56 member states.",
    date: "Nov 2023 - June 2026",
    className: "md:col-span-2",
  ...
  },
  {
    id: 3,
    title: "Data Analyst",
    company: "Taj Engineers",
    location: "Pune, India",
    desc: "Built forecasting models, ETL pipelines, and dashboards for production and inventory data to improve demand planning, while contributing to ERP development and automating reporting workflows.",
    date: "July 2020 - Jul 2022",
    className: "md:col-span-2",
    thumbnail: getImagePath("/exp4.svg"),
  },
  {
    ...
    location: "Bengaluru, India",
    desc: "Performed data cleaning and analysis using Excel and SQL to generate operational reports, supporting decision-making for the Rear Left-Hand Door (RLHD) production team.",

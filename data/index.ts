...
export const workExperience = [
  { 
     ...
     desc: "Designing and deploying GenAI agents with Microsoft Azure AI Foundry for enterprise clients, building end-to-end agentic AI workflows from data ingestion to production.",

...
const Footer = () => {
  return (
    <footer className="w-full pt-20 pb-10 relative overflow-hidden" id="contact">
      {/* background grid - modify positioning */}
      ...
      {/* Add relative positioning to content to appear above grid */}
      <div className="relative z-10">
        <div className="flex flex-col items-center">
          ...
          <a href="mailto:satyam3196@gmail.com">
            <MagicButton
